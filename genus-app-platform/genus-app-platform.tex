...
\afigure{img/gap-original-class-diagram.png}{A class diagram containing the most important classes to understand how data is stored and accessed in \gap.}{fig:gap-original-class-diagram}{0.9}
...
\afigure{img/gap-original-instantiation.png}{A data source with with composition objects. For each object, there are pointers to both data values and field descriptors.}{fig:gap-original-instantiation}{0.8}
