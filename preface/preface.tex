{\Huge Preface}
\vspace{1cm}
% The preface includes the facts - what type of project, where it is conducted, who supervised and any acknowledgments.
...
% Read academic writing MIT for inspiration
