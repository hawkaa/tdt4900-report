...
\todo{Not sure if I should include horizontal partitioning altogether}
...
\todo{Above two paragraphs must be adjusted to fit in}
...
\afigure{img/vectorized-execution.png}{\mssql~operators work on row batches. Each row batch contains thousands of rows stored as column vectors. Also, a bit vector indicates which rows that qualifies for a query. (Adapted from \cite{Larson2013-mc})}{fig:vectorized-execution}{0.4}
