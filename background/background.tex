...
In other words, the ref-count and the not-null terminated strings costs one extra level of indirection. See figure \ref{fig:delphi-strings}. Languages that uses null-terminated strings, like C and C++, does not have this artifact.
