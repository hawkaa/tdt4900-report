...
\subsection{Source Measure Lookup}
\label{sub:Source Measure Lookup}
\afigure{img/operations-get-double-array.png}{source measure lookup time for original, compressed column store, and compressed column store with \fn{GetDoubleArray} column operation, Benchmark \ref{bm:q1}, SF10. Logarithmic scale.}{fig:operations-get-double-array}{1.0}
...
\afigure{img/operations-get-lookup-index.png}{Lookup index generation time for original, compressed column store, and compressed column store with \fn{GetLookupIndex} column operation, Benchmark \ref{bm:q1}, SF10. Logarithmic scale.}{fig:operations-get-lookup-index}{1.0}
