...
The main deliverable from this research is this report which contains literature study, implementation details, tests results, and discussions of our findings. The report answers \textbf{RQ1} and address both goals stated in Section \ref{sec:Goals and Research Question}, with an emphasis on the design and experiment part of the research. This part takes a pragmatic approach: It is meant to show the potential of the technology, as well as accumulating experience, not a thorough analysis and experiment that checks all aspects of the applied methods. \todo{Rework}
...
\todo{Not sure if I am clear enough on how the thesis is structured}

The next four chapters belong to the second and main research phase, where techniques learnt from the litterature review is implemented in \gap. Each chapter contains an introduction, implementation, results, discussion, and conclusion, and corresponds to a research iteration. \todo{Should be done clearer?}
\begin{itemize}
...
\begin{itemize}
  \item \textbf{Chapter 10} discuss the results and implication of our findings, and sees it in a broader perspective. \todo{Rewrite after Ch. 9 is done}
